<?php
 ...
 if (class_exists('PDO')) {
   // echo 'PDO установлен на этом сервере.';
} else {
  //  echo 'PDO не установлен на этом сервере.';
}
    ...
    class crud{
        ...
        {
           try {
         $con=new PDO('mysql:localhost=h315225216.mysql; dbname=h315225216_db','h315225216_ser','Leendows87');
            return $con;
